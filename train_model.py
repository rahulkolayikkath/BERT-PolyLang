...
t_hf = Tokenizer.from_file("tokenizer_models/tokenizer-vocab1000.json")
...
text = open("data/7k_psmiles.txt", 'r')
...
# save the model 
torch.save(bert_lm.state_dict(), os.path.join("bert_models","model.pth"))
